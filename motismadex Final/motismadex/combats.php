...
<head>
    <meta charset="UTF-8">
	<meta name="description" content="Rejoignez la conversation, partagez vos équipes préférées, discutez des dernières stratégies de combat, et trouvez des compagnons de jeu pour des affrontements passionnants. MOTISMADEX est l'endroit où la communauté Pokémon prend vie, offrant une expérience immersive pour tous les amoureux de ces créatures fascinantes et des combats qui les animent.">
    <!--script-->
	...
	if (isset($_SESSION['user_id'])) {
		...
		if (isset($_POST['message'])) {
			...
			if ($resultCheckCombat && mysqli_num_rows($resultCheckCombat) == 0) {
				...
				//header("Location: spec.php?id=".$row["id"]);
			}
		}
	} else {
